...
> - - -
>
> 🗓️ `$= "<code>"+ dv.pages('"public/blips/2019-08-12-web-on-a-budget"')[0]["created-date"].setLocale("en-US").toLocaleString(dv.luxon.DateTime.DATE_MED_WITH_WEEKDAY) + "</code>"` `$= (!dv.pages('"public/blips/2019-08-12-web-on-a-budget"')[0]["created-date"].hasSame(dv.pages('"public/blips/2019-08-12-web-on-a-budget"')[0]["updated-date"], "day") ? " · ✏️ <code> " + dv.pages('"public/blips/2019-08-12-web-on-a-budget"')[0]["updated-date"].setLocale("en-US").toLocaleString(dv.luxon.DateTime.DATE_MED_WITH_WEEKDAY) + "</code>" : "")`  · [[public/blips/2019-08-12-web-on-a-budget\|🔗]]
{ #blip}
